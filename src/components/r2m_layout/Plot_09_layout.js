...
import Gallery from "./Gallery_Plot_09";
import pdf_09 from "./r2m_pdf/pdf_09.pdf";
import fp1 from "./r2m_images/plot_09/plot 9 plan.webp";
import fp2 from "./r2m_images/plot_09/PLOT 9 LIVING ROOM.webp";
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-5 bg-[#d2d2b4] bg-cover md:bg-opacity-90 text-[#40392d]">
      <h3 className="text-xl md:text-4xl font-semibold font-merriweather md:my-10 text-center p-3">
        1 BHK Apartment : Blissful Hillside Haven
        <br />
        Plot No - 09
        <br />
      </h3>
      ...
      <section className="w-full p-5 md:w-4/5 xl:w-3/4">
        <div>
          ...
          <div className=" flex flex-col md:flex-row justify-around gap-3 md:gap-12">
            <ol className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-10 xl:gap-x-20 md:py-5 w-fit md:px-10 mx-auto text-lg md:text-xl font-merriweather  ">
              <li className="flex animate__zoomIn3  px-2 gap-2 text-[#394422]  md:hover:text-yellow-50 ">
                <span> &#10146;</span> Super Built-up Area:{""}
                <span className="font-semibold">860 sq ft</span>
              </li>
              <li className="flex animate__zoomIn3  px-2 gap-2 text-[#394422]  md:hover:text-yellow-50 ">
                <span> &#10146;</span> Fully furnished Apartment
              </li>
            </ol>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-10 xl:gap-x-20 ">
          <div>
          ...
          <div>
            ...
            <ol className="grid grid-cols-1  gap-3 md:py-5 md:gap-x-16  text-lg md:text-xl font-merriweather ">
              <li className="flex animate__zoomIn3  px-2 gap-2 text-[#394422]  md:hover:text-yellow-50 ">
                <span> &#10146;</span> Quantity: 2 washrooms (1 common, 1 attached)
              </li>
              <li className="flex animate__zoomIn3  px-2 gap-2 text-[#394422]  md:hover:text-yellow-50 ">
      ...
      <section className="m-5 mt-0 md:pb-5 md:mb-0">
        <h3 className="text-2xl md:text-4xl font-semibold font-merriweather md:mb-10 text-center">
          FLOOR PLAN
        </h3>

        <div className="flex flex-col xl:flex-row  gap-5 md:gap-20 bg-cover md:py-5 bg-center">
    ...
    />
      ...
      <section className="p-3 flex flex-col justify-center items-center mt-0 pb-5">
        ...
        <div className="video-container">
          <iframe
            ...
            src="https://www.youtube.com/embed/wMewFF9S3RU"
      ...
      <section className="py-5 md:mx-5 flex">
        ...
        <a
          ...
          className="bg-green-900 text-white font-semibold text-xs md:text-xl  font-merriweather p-3 m-3 md:p-4 my-auto md:mr-8 md:px-8 rounded-xl hover:bg-green-300 hover:text-black hover:font-bold focus:outline-none"
        >
          Go Back
        </a>
      </section>
