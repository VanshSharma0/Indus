...
import img1 from "./r2m_sliders/Plot_3bhk_Wooden/iv1.webp";
import img2 from "./r2m_sliders/Plot_3bhk_Wooden/iv2.webp";
import img3 from "./r2m_sliders/Plot_3bhk_Wooden/iv3.webp";

const Slider_Plot_3bhk_Wooden = () => {
    const theme = {
        carousel: {
          defaultProps: {
...
export default Slider_Plot_3bhk_Wooden
