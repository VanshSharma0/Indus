...
import Gallery from "./Gallery_Studio_1bhk";
import pdf_69_first from "./r2m_pdf/pdf_69_first.pdf";
import fp1 from "./r2m_images/1bhk_studio_Apartment/PLOT N 69 INTERIOR.webp";
import fp2 from "./r2m_images/1bhk_studio_Apartment/PLOT N 69 TOP FLOOR.webp";
...
function Studio_1bhk_Apart_layout() {
  // ***********Image controller**************
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-5 bg-[#d2d2b4] bg-cover md:bg-opacity-90 text-[#40392d]">
      <h3 className="text-xl md:text-3xl xl:text-4xl font-semibold font-merriweather md:my-10 text-center p-3">
        Studio Retreat with Himalayan Horizons
        <br />
        Plot No - 69 : F1 / F2
        <br />
      </h3>
      ...
      <section className="w-full p-5 md:w-4/5 xl:w-3/4">
        <div>
          ...
          <div className=" flex flex-col md:flex-row justify-around gap-3 md:gap-12">
            <ol className="grid grid-cols-1 md:grid-cols-2  gap-3 md:py-5 w-full md:px-10  text-lg md:text-xl font-merriweather  ">
              <li className="flex animate__zoomIn3 px-2 gap-2 text-[#394422]  md:hover:text-yellow-50 ">
                <span> &#10146;</span> Super Built-up Area:{""}
                <span className="font-semibold">388 sq ft</span>
              </li>
              <li className="flex animate__zoomIn3 px-2 gap-2 text-[#394422]  md:hover:text-yellow-50 ">
                <span> &#10146;</span> Fully furnished Studio Apartment
              </li>
            </ol>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 xl:gap-x-20 ">
          <div>
          ...
          <div>
            ...
            <ol className="grid grid-cols-1  gap-3 md:py-5 md:gap-x-16  text-lg md:text-xl font-merriweather ">
              ...
              <li className="flex animate__zoomIn3 px-2 gap-2 text-[#394422]  md:hover:text-yellow-50 ">
                <span> &#10146;</span> Space: 1 bedroom with attached washroom
              </li>
              <li className="flex animate__zoomIn3 px-2 gap-2 text-[#394422]  md:hover:text-yellow-50 ">
                <span> &#10146;</span> View: Bay windows offering Nanda Devi Himalayan view
              </li>
              <li className="flex animate__zoomIn3 px-2 gap-2 text-[#394422]  md:hover:text-yellow-50 ">
                <span> &#10146;</span> Storage: Bedside table and wardrobe
              </li>
            </ol>
          </div>
          ...
          <div>
            ...
            <ol className="grid grid-cols-1  gap-3 md:py-5 md:gap-x-16  text-lg md:text-xl font-merriweather ">
              <li className="flex animate__zoomIn3 px-2 gap-2 text-[#394422]  md:hover:text-yellow-50 ">
                <span> &#10146;</span> Parking: Personal parking available for purchase
              </li>
              <li className="flex animate__zoomIn3 px-2 gap-2 text-[#394422]  md:hover:text-yellow-50 ">
      ...
      <section className="p-3 md:pb-5">
        <h3 className="text-xl md:text-2xl xl:text-3xl  font-semibold font-merriweather md:mb-5 text-center">
          FLOOR PLAN
        </h3>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 py-5 bg-cover bg-center">
  ...
  >
    ...
    />
      ...
      <section className="p-3 flex flex-col justify-center items-center mt-0 pb-5">
        <h3 className="text-xl md:text-2xl xl:text-3xl font-semibold font-merriweather md:mb-5 pb-5 text-center">
          YOUTUBE LINK
        </h3>
        ...
        <div className="video-container">
          <iframe
            ...
            src="https://www.youtube.com/embed/QKlwbctgr7U"
      ...
      <section className="p-3 mt-0 pb-5">
        <p className="text-xl md:text-2xl xl:text-3xl  font-semibold font-merriweather md:my-5 text-center  p-3">
          Price: 35 Lacs
        </p>
      </section>
      ...
      <section className="py-5 md:mx-5 flex">
        ...
        <button
          ...
          className="bg-green-900 text-white font-semibold text-xs md:text-xl font-merriweather m-3 p-3 md:p-4 my-auto md:mr-8 px-8 mr-5 rounded-xl hover:bg-green-300 hover:text-black hover:font-bold focus:outline-none"
        >
          Rate On Request
        </button>
        <a
...
export default Studio_1bhk_Apart_layout;
