...
import img1 from "./r2m_sliders/Plot_01/InnerView/iv1.webp";
import img2 from "./r2m_sliders/Plot_01/InnerView/iv2.webp";
import img3 from "./r2m_sliders/Plot_01/InnerView/iv3.webp";
import img4 from "./r2m_sliders/Plot_01/InnerView/iv4.webp";
import img5 from "./r2m_sliders/Plot_01/InnerView/iv5.webp";
...
function Slider_4bhk() {
  ...
  return (
      ...
      prevArrow={({ handlePrev }) => (
        ...
        >
          <svg
            ...
            strokeWidth={2}
            stroke="currentColor"
            className="h-6 w-6 md:text-black "
          >
            <path
              strokeLinecap="round"
    ...
    lastIndex ? null : ( // Render next arrow only if not the last image
      <IconButton
        variant="text"
        color="white"
        size="lg"
