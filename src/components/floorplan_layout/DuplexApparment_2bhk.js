...
import duplex_cottage from "./floorplan_images/duplex-cottage.webp";
import img1_1 from "./floorplan_images/1.1.jpg";
import img1_2 from "./floorplan_images/1.2.jpg";

import ppt_3 from "./floorplan_pdf/ppt_3.pdf";

const images = [img1_1, img1_2];

function DuplexApparment_2bhk() {
  ...
  return (
    <>
      <div
        style={{ backgroundImage: `url(${duplex_cottage})` }}
      ...
      <section className="flex flex-col m-5 md:p-20 gap-10 md:pt-0">
        ...
        <button
          onClick={() => window.open(ppt_3, "_blank")}
          className="bg-gray-400 font-semibold md:text-xl font-merriweather px-4 py-2 rounded-2xl hover:bg-black hover:text-white hover:font-bold focus:outline-none"
        >
...
export default DuplexApparment_2bhk;
